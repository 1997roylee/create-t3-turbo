...
var require_kill = __commonJS({
  "../../node_modules/execa/lib/kill.js"(exports2, module2) {
    ...
    var setExitHandler = (_0, _1, _2) => __async(exports2, [_0, _1, _2], function* (spawned, { cleanup, detached }, timedPromise) {
      if (!cleanup || detached) {
        return timedPromise;
      }
...
var require_stream = __commonJS({
  "../../node_modules/execa/lib/stream.js"(exports2, module2) {
    ...
    var getBufferedData = (stream, streamPromise) => __async(exports2, null, function* () {
      if (!stream) {
        return;
      }
      stream.destroy();
    ...
    var getSpawnedResult = (_0, _1, _2) => __async(exports2, [_0, _1, _2], function* ({ stdout, stderr, all }, { encoding, buffer, maxBuffer }, processDone) {
...
var require_promise = __commonJS({
  "../../node_modules/execa/lib/promise.js"(exports2, module2) {
    "use strict";
    var nativePromisePrototype = (() => __async(exports2, null, function* () {
...
var require_execa = __commonJS({
  "../../node_modules/execa/index.js"(exports2, module2) {
    ...
    var execa = (file, args, options) => {
      ...
      const handlePromise = () => __async(exports2, null, function* () {
...
var GIT_REPO = "https://github.com/1997roylee/create-t3-turbo.git";
var program = new import_commander.Command();
program.name("create-t3-turbo").description("CLI to create a new T3 APP with Turbo Monorepo").version("1.0.0");
program.argument("<app-name>", "Name of the app");
program.parse();
(() => __async(exports, null, function* () {
  try {
    const appName = program.args[0];
    console.log("Downloading files...");
    yield (0, import_execa.default)(`git clone --depth 1 ${GIT_REPO} ${appName}`);
    yield (0, import_execa.default)(`npx rimraf ./.git`);
    yield (0, import_execa.default)(`npx rimraf ./bin`);
